        ...
        <div className="relative2">
          <Tabs>
            ...
            <Tab label="Specifications">
              <div>
                <div>
                  <ul className="list-disc list-outside mb-4 ml-4 text-black">
                    <li className="py-2">Accurate, human-friendly flash system</li>
                    <li className="py-2">Double Exposure</li>
                    <li className="py-2">Self-timer</li>
                    <li className="py-2">
                  ...
                  <p className="font-sans text-black">View full specifications <span role="button" tabindex="0" className="underline" onClick={() => setIsOpen(!isOpen)}>here</span>.</p>
                </div>
              </div>
            </Tab>
          </Tabs>
