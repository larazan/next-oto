              ...
              <div className="flex w-full flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
                ...
                <div className="py-20 text-black">
                  ...
                  <div className="py-2 text-sm leading-tight">
                    Send us an email to tell us what’s up and someone from our
                    Customer Service team will get back to you as soon as
                    possible. Be sure to include your order number (if you have
                    one).
                  </div>
