        ...
        <div className={`w-full max-w-[1280px] px-5 md:px-10 mx-auto`}>
          ...
          <div className="flex flex-col md:flex-row gap-12 mb-10 md:py-10">
            ...
            <div className="flex-[1]">
              ...
              {/* BUTTON START */}
              <Link href={"/checkout"} 
              className="flex w-full text-md font-bold rounded-full transition-[all] duration-300 ease-out cursor-pointer bg-black text-white justify-center border-2 border-black hover:bg-white hover:text-black hover:border-solid py-3 px-7"
            //   className="w-full py-2 md:py-3 rounded-full uppercase  bg-gray-900 text-white text-lg font-semibold transition-transform active:scale-95 mb-3 hover:opacity-80 flex items-center gap-2 justify-center"
              >
                Checkout
