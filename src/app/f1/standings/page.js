          ...
          <div className="flex w-full flex-col space-y-2">
                ...
                <table className="min-w-[210px] text-sm">
                  <thead className="bg-white border border-gray-300">
                    <tr className="text-left">
                      <th className="text-xs text-left p-4 uppercase text-gray-500">
                        <p>Racer</p>
                      </th>
                  ...
                  <div className="w-full">
                    <table>
                      ...
                      <tbody>
                        {drivers.map((data, index) => {
                          return (
                            <tr className="bg-white text-gray-800 border border-gray-300" key={index}>
                              {glossary.map((data, index) => {
                                return (
                                  <td className="text-sm text-center py-2 px-1 uppercase" key={index}>
                                    <span>-</span>
                                  </td>
                                );
                              })}
            ...
            <div className="py-4">
                <div className="flex flex-col space-y-2">
                    <p className="uppercase font-semibold text-sm text-gray-900">glossary</p>
                    <div className="grid grid-cols-3 gap-2">
                        {glossary.map((data,index) => {
                          return (
<div>
                          <p className="text-gray-900 font-semibold text-xs">{data.alias}: <span className="font-sans">{data.name}</span></p>
                        </div>
                          )
                        })}
